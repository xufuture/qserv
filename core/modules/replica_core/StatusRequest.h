...
protected:
     ...
     */
    StatusRequestBase (const ServiceProvider::pointer                    &serviceProvider,
...
struct StatusReplicateRequestPolicy {
...
typedef StatusRequest<StatusReplicateRequestPolicy> StatusReplicateRequest;
