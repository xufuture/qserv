...
/// segment of results. The requester instance functions also functions as a
/// handle object that allows the original task owner to cancel the task,
/// indicating that no further bytes are desired.
