...
// class SqlResultIter
////////////////////////////////////////////////////////////////////////
SqlResultIter::SqlResultIter(MySqlConfig const& sqlConfig,
...
bool
SqlResultIter::_setup(MySqlConfig const& sqlConfig, std::string const& query) {
    _columnCount = 0;
...
SqlConnection::SqlConnection(MySqlConfig const& sc, bool useThreadMgmt)
    : _connection(new MySqlConnection(sc, useThreadMgmt)) {
}

void
SqlConnection::reset(MySqlConfig const& sc, bool useThreadMgmt) {
