...
.. note::
   ...
   Once Qserv stack is installed, updating Qserv package only doesn't require to launch above script.
   Please see :ref:`quick-start-install-qserv` and :ref:`quick-start-devel-setup-qserv` 
